...
public class ContactController implements Serializable {
	...
	public void saveContact(Contact contact){
		if (!this.rowSelected) {
			contactList.add(new Contact(this.getRandomId(), contact.getGivenName(), contact.getFamilyName(), contact.getContactNum(), contact.getAddress(), contact.getEmail(), contact.getPostalCode()));
			this.displayConfirmation("New Contact Added");
		} else {
			this.displayConfirmation("Record Updated");
		}
	}
